...
template <typename Scalar>
std::string sophusSE3ToString(const Sophus::SE3<Scalar>& se3) {
...
template <typename Scalar>
std::string sophusSim3ToString(const Sophus::Sim3<Scalar>& sim3) {
...
template <typename Scalar>
inline void sophusSE3ToTf(const Sophus::SE3<Scalar>& se3,
...
template <typename Scalar>
inline void tfToSophusSE3(const geometry_msgs::msg::Transform& tf,
                          Sophus::SE3<Scalar>* se3) {
  ...
  Eigen::Matrix<Scalar, 3, 1> trans(tf.translation.x,
                                    tf.translation.y,
                                    tf.translation.z);
  *se3 = Sophus::SE3<Scalar>(q, trans);
  return;
}

template <typename Scalar>
inline void poseToSophusSE3(const geometry_msgs::msg::Pose& pose,
                            Sophus::SE3<Scalar>* se3) {
