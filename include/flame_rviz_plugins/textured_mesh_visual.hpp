...
class TexturedMeshVisual final : public Visual {
 public:
   ...
   */
  void setFromMessage(const pcl_msgs::msg::PolygonMesh::ConstSharedPtr& msg,
                      const sensor_msgs::msg::Image::ConstSharedPtr& tex_msg = nullptr);
 ...
 private:
  ...
  void createMesh(const std::vector<sensor_msgs::msg::PointField>& fields);
