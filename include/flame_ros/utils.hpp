 ...
 */
// template <typename T>
// void getParamOrFail(const rclcpp::Node::SharedPtr nh, const std::string& name, T* val) {
//   if (!nh.getParam(name, *val)) {
//     RCLCPP_ERROR(nh->get_logger(), "Failed to find parameter: %s", nh.resolveName(name, true).c_str());
//     exit(1);
//   }
//   return;
// }
